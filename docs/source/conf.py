...
MOCK_MODULES = ['numpy', 'scipy', 'lmoments3', 'lmoments3.distr']
...
latex_documents = [
  ('index', 'StatisticalFloodEstimationTool.tex', 'Flood Estimation Library Documentation',
...
man_pages = [
    ('index', 'floodestimation', 'Flood Estimation Library Documentation',
...
texinfo_documents = [
  ('index', 'floodestimation', 'Flood Estimation Library Documentation',
   'Neil Nutt, Florenz A.P. Hollebrandse', 'floodestimation', 'One line description of project.',
   'Miscellaneous'),
]
