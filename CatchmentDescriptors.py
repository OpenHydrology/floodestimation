...
class Fpanel(wx.Panel):
    def __init__(self, parent,p):
        ...
        self.outlet_grid = wx.TextCtrl(self, -1, "-")
        self.outlet_x = wx.TextCtrl(self, -1, "-")
        self.outlet_y = wx.TextCtrl(self, -1, "-")
        self.centroid_grid = wx.TextCtrl(self, -1, "-")  
        self.centroid_x = wx.TextCtrl(self, -1, "310668")
        self.centroid_y = wx.TextCtrl(self, -1, "629329")        
        self.carea = wx.TextCtrl(self, -1, "-")
        self.altbar = wx.TextCtrl(self, -1, "-")
        self.aspbar = wx.TextCtrl(self, -1, "-")
        self.aspvar = wx.TextCtrl(self, -1, "-")
        self.bfihost = wx.TextCtrl(self, -1, "-")
        self.dplbar = wx.TextCtrl(self, -1, "-")
        self.dpsbar = wx.TextCtrl(self, -1, "-")
        self.farl = wx.TextCtrl(self, -1, "-")
        self.fpext = wx.TextCtrl(self, -1, "-")
        self.ldp = wx.TextCtrl(self, -1, "-")
        self.propwet = wx.TextCtrl(self, -1, "-")
        self.saar = wx.TextCtrl(self, -1, "-")
        self.sprhost = wx.TextCtrl(self, -1, "-")
        self.urbconc1990 = wx.TextCtrl(self, -1, "-")
        self.urbconc2000 = wx.TextCtrl(self, -1, "-")
        self.urbext1990 = wx.TextCtrl(self, -1, "-")
        self.urbext2000 = wx.TextCtrl(self, -1, "-")
        self.urbloc1990 = wx.TextCtrl(self, -1, "-")
        self.urbloc2000 = wx.TextCtrl(self, -1, "-")
        self.chnl_width = wx.TextCtrl(self, -1, "-")
        self.assessment_year = wx.TextCtrl(self, -1, time.asctime(time.localtime())[-4:])
        
        self.outlet_note = wx.TextCtrl(self, -1, "")
        self.centroid_note = wx.TextCtrl(self, -1, "")
        self.carea_note = wx.TextCtrl(self, -1, "")
        self.altbar_note = wx.TextCtrl(self, -1, "")
        self.aspbar_note = wx.TextCtrl(self, -1, "")
        self.aspvar_note = wx.TextCtrl(self, -1, "")
        self.bfihost_note = wx.TextCtrl(self, -1, "")
        self.dplbar_note = wx.TextCtrl(self, -1, "")
        self.dpsbar_note = wx.TextCtrl(self, -1, "")
        self.farl_note = wx.TextCtrl(self, -1, "")
        self.fpext_note = wx.TextCtrl(self, -1, "")
        self.ldp_note = wx.TextCtrl(self, -1, "")
        self.propwet_note = wx.TextCtrl(self, -1, "")
        self.saar_note = wx.TextCtrl(self, -1, "")
        self.sprhost_note = wx.TextCtrl(self, -1, "")
        self.urbconc1990_note = wx.TextCtrl(self, -1, "")
        self.urbconc2000_note = wx.TextCtrl(self, -1, "")
        self.urbext1990_note = wx.TextCtrl(self, -1, "")
        self.urbext2000_note = wx.TextCtrl(self, -1, "")
        self.urbloc1990_note = wx.TextCtrl(self, -1, "")
        self.urbloc2000_note = wx.TextCtrl(self, -1, "")
        self.chnl_width_note = wx.TextCtrl(self, -1, "")
