...
MOCK_MODULES = ['numpy', 'scipy', 'lmoments3']
...
htmlhelp_basename = 'StatisticalFloodEstimationTooldoc'
...
latex_documents = [
  ('index', 'StatisticalFloodEstimationTool.tex', 'Statistical Flood Estimation Tool Documentation',
...
man_pages = [
    ('index', 'statisticalfloodestimationtool', 'Statistical Flood Estimation Tool Documentation',
...
texinfo_documents = [
  ('index', 'StatisticalFloodEstimationTool', 'Statistical Flood Estimation Tool Documentation',
   'Neil Nutt, Florenz A.P. Hollebrandse', 'StatisticalFloodEstimationTool', 'One line description of project.',
   'Miscellaneous'),
]
